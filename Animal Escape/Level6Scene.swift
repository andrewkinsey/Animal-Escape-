...
class Level6Scene: SKScene, SKPhysicsContactDelegate
{
    ...
    func createGame()
    {
        ...
        makeTimer(time: "\(time)")
        startTimer()
        makeGiraffe(xPosition: 450, yPosition: 900)
        makeZebra(xPosition: 570, yPosition: 950)
        makeTiger(xPosition: 570, yPosition: 600)
        makeCheetah(xPosition: 500, yPosition: 500)
        makeParrot(xPosition: 600, yPosition: 760)
        makeSnake(xPosition: 250, yPosition: 550)
    }
