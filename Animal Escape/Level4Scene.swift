...
class Level4Scene: SKScene, SKPhysicsContactDelegate
{
    ...
    func createGame()
    {
        ...
        makeTimer(time: "\(time)")
        startTimer()
        makeGiraffe(xPosition: 350, yPosition: 760)
        makeZebra(xPosition: 400, yPosition: 350)
        makeTiger(xPosition: 340, yPosition: 500)
        makeCheetah(xPosition: 180, yPosition: 500)
        makeParrot(xPosition: 500, yPosition: 550)
